...
def load_data(tiedie_network, tiedie_heats, hmi, tf_tg_network, endpoint, sep, endpoint_value_column, endpoint_pvalue_column):
    ...
    return rec_tf, heats, hbps, tf_deg, endpoint
...
def main():
    ...
    rec_tf, heats, hbps, tf_deg, exp = load_data(args.tiedie_file, args.heats_file, args.hmi_file, args.tf_tg_file, args.endpoint_file, args.sep_endpoint, args.endpoint_value_column, args.endpoint_pvalue_column)
